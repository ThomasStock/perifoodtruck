...
<dialog id="help-dialog"><div class="dialog-heading"><h2>How your lunch run works</h2><button data-close="help-dialog" aria-label="Close help">×</button></div><ol><li><b>Stop anywhere.</b> Press E or tap the action button to leave your stopped truck. Walk back and press E to get in. Kiosk and trailer actions take priority when available.</li><li><b>Walk to the kiosk.</b> Choose fries, burgers, snacks and sauces. Your total includes a ${euro(ORDER_FEE_CENTS)} order fee.</li><li><b>Collect your trailer.</b> Confirm at the kiosk, get back in and follow the marker to your name. The gate is open. Back gently towards your trailer and press E to attach. A slight angle is fine.</li><li><b>Drive through EXIT.</b> Use the opening in the right-hand fence. Your order is placed when your entire trailer is outside.</li></ol><p>Other players and their trailers are ghosts: visible, but they never block you. After placing your order, you can keep driving as a ghost. Hold Space or the mobile ⚡ button while driving for turbo.</p></dialog>`;
...
function paint() {
  ...
  $("mission").dataset.brief = {
    arrive: "Stop anywhere · E to get out",
  ...
  if (p.onFoot)
    $("mission").dataset.brief = "Walk back to your truck · E to get in";
