...
3. Click anywhere on a menu card to add an item. Choose from Fries, Burgers, Snacks, and Sauces. The menu includes 75 items, excludes Friet maison, and charges €1.50 per order. Sauces and toppings cost €1.20 per pot, except the two speciaal combinations at €2.20. All menu items are sold at their regular prices without promotional free portions. Previously saved orders retain their original quantities.
