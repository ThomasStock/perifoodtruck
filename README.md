...
Once inside the site, the assigned dock's rolling shutter opens once the whole opening has been comfortably in view for 0.8 seconds within 42 m of the rig. The shutter rises over 3.5 seconds, revealing a lit loading bay and stocked racks. A worker then walks up from inside over 3.8 seconds and pauses beside the opening. Only after that pause, and within 18 m of the rig, a forklift carrying a boxed pallet rolls forward and waits entirely inside the threshold. The door and crew stay ready through the turnaround and delivery; restarting resets them. Reduced motion shows each stage immediately.
...
npm run truck -- register --booking PP-K4M7Q2 --language pl --phone "+32 470 12 34 56"
